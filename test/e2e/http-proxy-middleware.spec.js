  ...
  describe('http-proxy-middleware in actual server', function () {
    describe('basic setup, requests to target', function () {
      ...
      beforeEach(function (done) {
        ...
        http.get('http://localhost:3000/api/b/c/dp?q=1&r=[2,3]#s"', function (res) {
    ...
    describe('option.headers - additional request headers', function () {
      ...
      beforeEach(function (done) {
        var mwProxy = proxyMiddleware('/api', {target: 'http://localhost:8000', headers: {host: 'foobar.dev'}})
    ...
    describe('legacy option.proxyHost', function () {
      ...
      beforeEach(function (done) {
        var mwProxy = proxyMiddleware('/api', {target: 'http://localhost:8000', proxyHost: 'foobar.dev'})
